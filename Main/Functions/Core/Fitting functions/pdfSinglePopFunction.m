%% Generate the likelihood of fitting this pdf function - LIN variant
...
%---------------------------------------------------------
function output = pdfSinglePopFunction(xdata,D,offset,loc_unc,strobo_frame_time,frame_time)
