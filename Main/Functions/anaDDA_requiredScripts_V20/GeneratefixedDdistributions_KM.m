function [Dfixed, fitspecies, fixedspecies] = GeneratefixedDdistributions_KM(numberofspecies, fixedparameters, rangeD,inputdistlocerrorpdfcorrected,input)
...
if sum(fixedparameters(i,2:4)>-1) == 3
    Dfixed(i,j).dist = DDistributiongenerator(fixedparameters(i,2),fixedparameters(i,3),fixedparameters(i,4),rangeD,inputdistlocerrorpdfcorrected,maxindex,fx,fy,maxDindtracking,input,j)';
